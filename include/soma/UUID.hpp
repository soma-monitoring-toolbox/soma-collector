 ...
 */
#ifndef __SOMA_UUID_UTIL_HPP
#define __SOMA_UUID_UTIL_HPP
...
namespace std {
    ...
    /**
     * @brief Specialization of std::hash for soma::UUID
     */
    template<>
    struct hash<soma::UUID> 
    {
        size_t operator()(const soma::UUID& id) const
        {
            return id.hash();
        }
    };
